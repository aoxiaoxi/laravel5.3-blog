    ...
    <form action="{{url('admin/links/'.$data->link_id)}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="link_name" value="{{old('link_name')??$data->link_name}}">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" name="link_url" value="{{old('link_url')??$data->link_url}}">
                </td>
            </tr>
            <tr>
                <th>链接标题：</th>
                <td>
                    <input type="text" class="lg" name="link_title" value="{{old('link_title')??$data->link_title}}">
                </td>
            </tr>
            <tr>
                <th>排序：</th>
                <td>
                    <input type="text" class="sm" name="link_order" value="{{old('link_order')??$data->link_order}}">
                </td>
            </tr>
            <tr>
                <th></th>
