	...
	<ul>
		<li>
			...
			<ul class="sub_menu">
				...
				<li><a href="{{url('admin/category/index')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>分类列表</a></li>
		...
		<li>
			...
			<ul class="sub_menu" style="display:block;">
				<li><a href="{{url('admin/links')}}" target="main"><i class="fa fa-fw fa-share-alt"></i>友情链接</a></li>
